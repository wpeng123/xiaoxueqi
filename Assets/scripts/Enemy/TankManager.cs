...
public class TankManager : MonoBehaviour
{
    ...
    void AniMGunStart()
    {
        GetChild(this.transform, "坦克机枪射击（6秒）").gameObject.SetActive(true);
        BulletShoot.SetBool("MGun", true);
        Invoke("AniMGunStop", bulletAmount * bulletFrequency);
    }
    void AniMGunStop()
    {
        GetChild(this.transform, "坦克机枪射击（6秒）").gameObject.SetActive(false);
    ...
    {
        GetChild(this.transform, "坦克炮弹发射").gameObject.SetActive(false);
    ...
    {
        GetChild(this.transform, "坦克炮弹发射").gameObject.SetActive(true);
